...
/* ToDo: remove this */
// b8:59:9f:38:57:e4
#define HOST_MAC ((uint8_t[]){0xb8, 0x59, 0x9f, 0x38, 0x57, 0xe4})
// 98:03:9b:1e:dd:48
#define CLIENT_MAC ((uint8_t[]){0x98, 0x03, 0x9b, 0x1e, 0xdd, 0x48})
// 08:c0:eb:62:45:04
#define SERVER_MAC ((uint8_t[]){0x08, 0xc0, 0xeb, 0x62, 0x45, 0x04})
