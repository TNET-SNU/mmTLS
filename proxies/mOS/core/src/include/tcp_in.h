...
#define TCP_TIMEOUT				(MSEC_TO_USEC(30) / TIME_TICK)	// 30s
...
enum tcp_state
{
	...
	TCP_ST_LAST_ACK		= 9, 
	TCP_ST_TIME_WAIT	= 10,
	/* 151020 dhkim: TCP_ST_CLOSED_RSVD is only for internal use to
	 * differentiate a finished connection and a connection before starting.
	 * This state will be presented as TCP_CLOSED for the user. */
