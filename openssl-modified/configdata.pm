...
our %config = (
    ...
    "openssl_sys_defines" => [],
    "openssldir" => "",
    "options" => "--prefix=/home/junghan/mmTLS/nginx-modified/../openssl-modified/.openssl no-acvp-tests no-asan no-brotli no-brotli-dynamic no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-default-thread-pool no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fips no-fips-securitychecks no-fuzz-afl no-fuzz-libfuzzer no-ktls no-loadereng no-md2 no-msan no-quic no-rc5 no-sctp no-shared no-ssl3 no-ssl3-method no-tfo no-thread-pool no-threads no-trace no-ubsan no-unit-test no-uplink no-weak-ssl-ciphers no-winstore no-zlib no-zlib-dynamic no-zstd no-zstd-dynamic",
    "patch" => "0",
    ...
    "dirinfo" => {
        ...
        "crypto/bn" => {
            "deps" => [
                ...
                "crypto/bn/liblegacy-lib-rsaz-2k-avx512.o",
                "crypto/bn/liblegacy-lib-rsaz-3k-avx512.o",
                "crypto/bn/liblegacy-lib-rsaz-4k-avx512.o",
                "crypto/bn/liblegacy-lib-rsaz-avx2.o",
                "crypto/bn/liblegacy-lib-rsaz-x86_64.o",
                "crypto/bn/liblegacy-lib-rsaz_exp.o",
                "crypto/bn/liblegacy-lib-rsaz_exp_x2.o",
        ...
        "crypto/bn/asm" => {
            "deps" => [
                ...
                "crypto/bn/asm/liblegacy-lib-x86_64-gcc.o"
            ],
            "products" => {
                "lib" => [
                    "libcrypto",
...
unless (caller) {
    ...
    use lib '/home/junghan/mmTLS/openssl-modified/util/perl';
    use OpenSSL::fallback '/home/junghan/mmTLS/openssl-modified/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/home/junghan/mmTLS/openssl-modified/Configurations';
        use gentemplate;
